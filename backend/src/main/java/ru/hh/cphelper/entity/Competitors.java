...
//    public Competitors(Integer employerId, Integer competitorId, Integer areaId, Float relevanceIndex) {
//        this.employerId = employerId;
//        this.competitorId = competitorId;
//        this.areaId = areaId;
//        if (relevanceIndex != null)
//            this.relevanceIndex = relevanceIndex;
//    }

    public Competitors(Integer employerId, Integer competitorId, Integer areaId) {
        this.employerId = employerId;
        this.competitorId = competitorId;
        this.areaId = areaId;
    }
